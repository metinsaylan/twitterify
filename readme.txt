...
This plugin automatically converts **hashtags** (like #wordpress) to tag links, **@links** to author links (like @metinsaylan), and autolinks URIs (like http://wpassist.me ) to links. Some benefits of Twitterify are:
...
== Installation ==
 ...
 1. Activate the plugin when the plugin is uploaded. 
...
You can ask your questions [here](http://wpassist.me/plugins/twitterify/)
